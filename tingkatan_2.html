...
<html lang = "en">
	...
	<body>
		...
		<p><center>Kelas Tingkatan 2</center></p>
				...
				<button><a href="dua_a.html">2 Arif</a></button>
				<button><a href="dua_b.html">2 Bestari </a></button>
				<button><a href="dua_c.html">2 Cendekiawan</a></button>
				<button><a href="dua_d.html">2 Dinamik</a></button>
				<button><a href="duaabcd.html">Seluruh tingkatan</a></button>
