...
<html lang = "en">
	...
	<body>
		...
		<p><center>Kelas Tingkatan 3</center></p>
				...
				<button><a href="tiga_a.html">3 Arif</a></button>
				<button><a href="tiga_b.html">3 Bestari </a></button>
				<button><a href="tiga_c.html">3 Cendekiawan</a></button>
				<button><a href="tiga_d.html">3 Dinamik</a></button>
				<button><a href="tigaabcd.html">Seluruh tingkatan</a></button>
		</div>
